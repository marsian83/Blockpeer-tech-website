...
type FooterLink = Record<string, Array<{name : string, uri : string}>>
...
const footerLinks: FooterLink = {
  ...
  'Legal': [
    {
      name: "Return Policy",
      uri: "document/ReturnsPolicy"
    },
    {
      name: "Acceptable Use Policy",
      uri: "/document/AcceptableUsePolicy"
    },
    {
      name: "Cookie Policy",
      uri: "/document/CookiePolicy"
    },
    {
      name: "Privacy Policy",
      uri: "/document/PrivacyPolicy"
    },
    {
      name: "Terms of Service",
      uri: "document/Termsofservice"
    },
              ...
              {Object.keys(footerLinks).map((title, idx) => {
                return (
                  <div className="flex flex-col gap-3" key={idx}>
                    ...
                    {footerLinks[title].map((link, idx) => {
                      return (
